...
const experiences = [
  ...
  },
  {
    ...
    company: 'Saikoro',
    companyUrl: 'https://saikorotech.com/',
    location: 'Remote',
    period: '2022 - 2024',
    type: 'Full-time',
    description: [
  ...
  },
  {
    ...
    company: 'Valeo Egypt',
    companyUrl: 'www.valeo.com/en/egypt/',
    location: 'Egypt',
    period: '2 Months',
    type: 'Internship',
    description: [
      ...
      'Gained hands-on experience with software architecture and embedded C programming',
    ],
    technologies: ['Embedded C', 'Software Architecture', 'Automotive', 'RTOS'],
              ...
              >
                ...
                <div className='absolute left-4 md:left-1/2 transform -translate-x-1/2 z-10'>
                  ...
                  >
                    ...
                    />
                    <div
                      className={`absolute inset-0 w-4 h-4 rounded-full bg-gradient-to-r ${exp.color} animate-ping opacity-50`}
                    />
                  </motion.div>
                </div>
                ...
                {/* Content */}
                <div
                  className={`w-full md:w-1/2 ${index % 2 === 0 ? 'md:pr-12' : 'md:pl-12'} pl-12 md:pl-0`}
                >
                  <motion.div
                  ...
                  >
                    {/* Glow effect */}
                    <div
                      className={`absolute -inset-0.5 bg-gradient-to-r ${exp.color} rounded-2xl blur opacity-0 group-hover:opacity-30 transition-opacity duration-500`}
                    />
